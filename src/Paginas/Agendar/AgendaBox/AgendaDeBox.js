...
import styles from "./estilo_agenda.module.css"; // Importamos el archivo de estilos
...
const AgendamientoSesiones = () => {
  ...
  return (
    <div className={`${styles.container} container mt-4`}>
      {" "}
      {/* Clases de CSS Module y Bootstrap */}
      <form action="mapa-box.html" method="get">
        <div className="row">
          {[
            {
              id: "sucursal",
            ...
            <div key={id} className="col-md-6 mb-3">
              <div className={styles.formGroup}>
                {" "}
                {/* Aplicamos estilos personalizados del CSS Module */}
